  ...
  const handleGoogleRegister = async () => {
    try {
      ...
      if (result.user) {
        ...
        // Avanzar automáticamente a la fase 2
        setCurrentPhase(2);
      }
    } catch (error: any) {
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10"
          ...
          {currentPhase === 1 && (
            <div className="space-y-8">
              {/* Google Register Button - Only in Phase 1 */}
              {!googleUserData && (
                <>
                  <div>
                    <button
                      ...
                      className="w-full py-3 px-4 bg-white hover:bg-gray-50 text-gray-900 font-medium rounded-lg transition-all duration-200 flex items-center justify-center space-x-3 border border-gray-300 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {isGoogleLoading ? (
                      ...
                      <span>{isGoogleLoading ? 'Registering to Google...' : 'Continue with Google'}</span>
                    </button>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-sm">
                      <span className="px-4 bg-[#1E1E1E] text-[#B3B3B3]">Or complete manually</span>
                    </div>
                  </div>
                </>
              )}
                ...
                <div className="lg:col-span-1 flex flex-col items-center justify-start">
                  <div className="w-full">
                    ...
                    <div className="flex flex-col items-center space-y-4">
                      ...
                      {googleUserData && (
                        <p className="text-green-400 text-xs text-center">✓ Photo obtained from Google</p>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="pt-4">
                    <button
                      ...
                      className="w-full py-3 rounded-lg font-bold text-base transition-all duration-300 transform hover:scale-105"
                      style={{
          ...
          {currentPhase === 1 && (
            <div className="mt-8 text-center border-t border-white/10 pt-6">
              ...
              <div className="space-y-2">
                <a href="/login" className="block text-[#228B22] hover:underline font-medium text-sm">
                  Sign In
                </a>
                <div className="flex items-center justify-center space-x-2 text-xs text-[#B3B3B3]">
                  <span>Are you a tourist?</span>
                  <a href="/registerTourist" className="text-[#228B22] hover:underline font-medium">
                    Register here
                  </a>
                </div>
              </div>
